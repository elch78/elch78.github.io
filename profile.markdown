...
# Nils Rommelfanger
**Software Engineer Coous Delivery**
...
I am a software engineer with a strong DevOps mindset and **19 years of experience** in backend technology. I bring a comprehensive skill set spanning architecture, clean code practices, automated testing, legacy code refactoring, deployment pipelines, operations, and observability.

I firmly believe that clean code, CI/CD, TDD, and fast feedback loops are essential not only for delivering high-quality software but also for achieving high development velocity. By continuously improving every aspect of the codebase, I keep software maintainable and enable efficient, sustainable development.
...
With nearly two decades of experience across diverse domains—from IoT platforms and autonomous systems to financial services and e-mobility—I bring deep technical expertise combined with a pragmatic, results-oriented approach. I excel at:
...
Whether you need someone to architect a greenfield project, rescue a struggling codebase, or accelerate your team's delivery, I'm ready to help.
